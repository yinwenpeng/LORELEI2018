...
from load_data import  load_trainingData_types,load_trainingData_types_plus_others,load_il9_NI_test,load_fasttext_multiple_word2vec_given_file,load_word2vec_to_init, load_BBN_il5Trans_il5_dataset,load_SF_type_descriptions
...
def evaluate_lenet5(learning_rate=0.01, n_epochs=4, emb_size=300, batch_size=10, describ_max_len=20, type_size=12,filter_size=[3,5], maxSentLen=100, hidden_size=[300,300]):
    ...
    test_sents, test_masks, test_labels,word2id = load_il9_NI_test(word2id, maxSentLen)
    ...
    word2vec=load_fasttext_multiple_word2vec_given_file([emb_root+'100k-ENG-multicca.300.ENG.txt',emb_root+'100k-SWA-multicca.d300.SWA.txt',emb_root+'100k-IL9-multicca.d300.IL9.txt'], 300)
