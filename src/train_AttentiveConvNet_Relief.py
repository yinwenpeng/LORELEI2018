...
from common_functions import store_model_to_file,Conv_with_Mask, Attentive_Conv_for_Pair,create_conv_para, create_HiddenLayer_para, create_ensemble_para, Gradient_Cost_Para
...
def evaluate_lenet5(learning_rate=0.02, n_epochs=100, emb_size=300, batch_size=50, filter_size=[3,5,7], maxSentLen=300, hidden_size=[300,300]):
    ...
    LR_input = T.concatenate([sent_embeddings,sent_embeddings2, sent_embeddings3], axis=1)
    LR_input_size = hidden_size[0]*3
