...
def evaluate_lenet5(learning_rate=0.005, n_epochs=4, emb_size=100, batch_size=50, describ_max_len=20, type_size=12,filter_size=[3,5], maxSentLen=100, hidden_size=[300,300]):
    ...
    word2vec=load_fasttext_multiple_word2vec_given_file([emb_root+'100k-IL9-cca.d100.eng.txt',emb_root+'100k-IL9-cca.d100.IL9.txt'], 100)
