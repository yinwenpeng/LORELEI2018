...
def load_swa():
    ...
    folder = '/save/wenpeng/datasets/LORELEI/swa/monolingual_text/ltf/'
    docid2text={}
    re=0
    ...
    '''
    docid2issue = {}
    folder = '/save/wenpeng/datasets/LORELEI/swa/annotation/issues/'
    files= os.listdir(folder)
    ...
    mentions: doc_id:[{'entity_id': place_id, 'entity_type': GPE, 'start_char':12,'end_char':15}]
    '''
    folder = '/save/wenpeng/datasets/LORELEI/swa/annotation/mentions/'
    files= os.listdir(folder)
    ...
    '''
    docid2need = {}
    folder = '/save/wenpeng/datasets/LORELEI/swa/annotation/needs/'
    files= os.listdir(folder)
...
def generate_entity_focused_trainingset(docid2text, docid2issue, docid2mention, docid2need):
    ...
    writefile = codecs.open('/save/wenpeng/datasets/LORELEI/swa_labeled_as_training_seg_level.txt', 'w', 'utf-8')
    write_size = 0
...
if __name__ == '__main__':
    docid2text, docid2issue, docid2mention, docid2need = load_swa()
